(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('async-array-buffer'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/assertThisInitialized'), require('@babel/runtime/helpers/defineProperty'), require('tslib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'async-array-buffer', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/inherits', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/assertThisInitialized', '@babel/runtime/helpers/defineProperty', 'tslib'], factory) :
    (global = global || self, factory(global.standardizedAudioContext = {}, global.asyncArrayBuffer, global._typeof, global._classCallCheck, global._slicedToArray, global._createClass, global._possibleConstructorReturn, global._getPrototypeOf, global._inherits, global._regeneratorRuntime, global._asyncToGenerator, global._toConsumableArray, global._assertThisInitialized, global._defineProperty, global.tslib_1));
}(this, function (exports, asyncArrayBuffer, _typeof, _classCallCheck, _slicedToArray, _createClass, _possibleConstructorReturn, _getPrototypeOf, _inherits, _regeneratorRuntime, _asyncToGenerator, _toConsumableArray, _assertThisInitialized, _defineProperty, tslib_1) { 'use strict';
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function AudioBufferSourceNode(context) {
            ...
            _this._nativeAudioBufferSourceNode = nativeAudioBufferSourceNode; // Bug #73: Edge & Safari do not export the correct values for maxValue and minValue.
    ...
    var createBaseAudioContextConstructor = function createBaseAudioContextConstructor(addAudioWorkletModule, analyserNodeConstructor, audioBufferConstructor, audioBufferSourceNodeConstructor, biquadFilterNodeConstructor, channelMergerNodeConstructor, channelSplitterNodeConstructor, constantSourceNodeConstructor, convolverNodeConstructor, _decodeAudioData, delayNodeConstructor, dynamicsCompressorNodeConstructor, gainNodeConstructor, iIRFilterNodeConstructor, minimalBaseAudioContextConstructor, oscillatorNodeConstructor, periodicWaveConstructor, stereoPannerNodeConstructor, waveShaperNodeConstructor) {
      return (
        /*#__PURE__*/
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function BiquadFilterNode(context) {
            ...
            _this._Q = createAudioParam(context, isOffline, nativeBiquadFilterNode.Q, 3.4028234663852886e38, -3.4028234663852886e38); // Bug #78: Edge & Safari do not export the correct values for maxValue and minValue.
            ...
            _this._frequency = createAudioParam(context, isOffline, nativeBiquadFilterNode.frequency, 3.4028234663852886e38, -3.4028234663852886e38); // Bug #79: Edge & Safari do not export the correct values for maxValue and minValue.
    ...
    var createDynamicsCompressorNodeRendererFactory = function createDynamicsCompressorNodeRendererFactory(createNativeDynamicsCompressorNode) {
      return function () {
        var nativeDynamicsCompressorNode = null;
        return {
          render: function () {
            var _render = _asyncToGenerator(
            /*#__PURE__*/
    ...
    var createIsSupportedPromise = function createIsSupportedPromise(browsernizr, testAsyncArrayBufferSupport, testAudioContextCloseMethodSupport, testAudioContextDecodeAudioDataMethodTypeErrorSupport, testAudioContextOptionsSupport, testChannelMergerNodeSupport, testChannelSplitterNodeChannelCountSupport, testConstantSourceNodeAccurateSchedulingSupport, testIsSecureContextSupport, testStereoPannerNodeDefaultValueSupport) {
      if (browsernizr.promises && browsernizr.typedarrays && browsernizr.webaudio && cacheTestResult(testAudioContextCloseMethodSupport, function () {
      ...
      }) && cacheTestResult(testConstantSourceNodeAccurateSchedulingSupport, function () {
        return testConstantSourceNodeAccurateSchedulingSupport();
        ...
        }), cacheTestResult(testStereoPannerNodeDefaultValueSupport, function () {
          return testStereoPannerNodeDefaultValueSupport();
        })]).then(function (_ref) {
      ...
      return (
        ...
        function (_EventTarget) {
          ...
          function MinimalBaseAudioContext(nativeContext, numberOfChannels) {
            ...
            _this._listener = createAudioListener(_assertThisInitialized(_assertThisInitialized(_this)), nativeContext);
            _this._nativeContext = nativeContext;
            return _this;
          }
    ...
    var createPeriodicWaveConstructor = function createPeriodicWaveConstructor(createNativePeriodicWave) {
      return function PeriodicWave(context, options) {
        ...
        var nativeContext = getNativeContext(context);
        var mergedOptions = Object.assign({}, DEFAULT_OPTIONS$i, options); // This does violate all good pratices but it is used here to simplify the handling of periodic waves.
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function StereoPannerNode(context) {
            ...
            var nativeContext = getNativeContext(context);
            var mergedOptions = Object.assign({}, DEFAULT_OPTIONS$j, options);
